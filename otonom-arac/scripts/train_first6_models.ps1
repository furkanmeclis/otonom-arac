...
$models = @(
    @{
        Id = "MODEL-01"
        Config = "configs/model_01_pure_sim.py"
        ModelPath = "models/model_01_pure_sim.keras"
        Experiment = "model_01_pure_sim"
        Epochs = 30
    },
    @{
        Id = "MODEL-02"
        Config = "configs/model_02_sim_domain_randomization.py"
        ModelPath = "models/model_02_sim_domain_randomization.keras"
        Experiment = "model_02_sim_domain_randomization"
        Epochs = 30
    },
    @{
        Id = "MODEL-03"
        Config = "configs/model_03_pure_real.py"
        ModelPath = "models/model_03_pure_real.keras"
        Experiment = "model_03_pure_real"
        Epochs = 30
    },
    @{
        Id = "MODEL-04"
        Config = "configs/model_04_hybrid_v1_naive_mix.py"
        ModelPath = "models/model_04_hybrid_v1_naive_mix.keras"
        Experiment = "model_04_hybrid_v1_naive_mix"
        Epochs = 30
    },
    @{
        Id = "MODEL-05"
