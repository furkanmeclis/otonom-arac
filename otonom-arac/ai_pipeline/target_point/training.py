"""Manifest-native target-point training entrypoint for Phase 4."""
...
class WeightedNormalizedMSE(keras.losses.Loss):
    """Axis-weighted MSE on normalized target-point coordinates."""
...
class TargetPointSequence(keras.utils.Sequence):
    """Keras Sequence that loads images on demand for manifest-based training."""
...
class CollapseMonitorCallback(keras.callbacks.Callback):
    """Log prediction spread and correlation per epoch to catch collapse early."""
