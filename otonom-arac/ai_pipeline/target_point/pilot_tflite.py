"""Lightweight TFLite inference pilot for Jetson deployment."""
...
class TargetPointPilotTFLite:
    """DonkeyCar-compatible pilot using TFLite interpreter.

    Designed for low-latency inference on Jetson Nano/Orin with
    INT8 or FP16 quantized models.
    """
