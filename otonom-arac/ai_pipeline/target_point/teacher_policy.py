"""Mapping and collection teachers plus target-point label policies."""
...
class LowNoiseTargetPointTeacher:
    """Privileged track-following teacher for Phase 2 and Phase 3 collection."""
...
class CleanMappingTeacher:
    """Safety-first privileged mapper using simulator-only state."""
