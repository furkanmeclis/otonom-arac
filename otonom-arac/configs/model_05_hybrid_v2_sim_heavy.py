...
TARGET_POINT_EXPERIMENT_PREFIX = "model_05_hybrid_v2_sim_heavy"
...
TARGET_POINT_AUG_BRIGHTNESS_LIMIT = 0.35
TARGET_POINT_AUG_CONTRAST_LIMIT = 0.30
TARGET_POINT_AUG_BLUR_RADIUS_MAX = 2.5
TARGET_POINT_AUG_RGB_SHIFT_MAX = 20
TARGET_POINT_AUG_SHIFT_PX_MAX = 8.0
TARGET_POINT_AUG_ROTATION_DEG_MAX = 4.0
TARGET_POINT_AUG_PERSPECTIVE_PX_MAX = 8.0
