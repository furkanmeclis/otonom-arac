...
TARGET_POINT_FINE_TUNE_FROZEN_LAYERS = 0 # DUZELTME: kaydedilen model nested (CNN tek katman).
# 6 vermek model.layers[:3]'u, yani TUM CNN'i donduruyordu -> 0 egitilebilir param -> duz loss.
# 0 = hicbir sey dondurma; tum 33.858 param model_01 agirliklarindan dusuk LR ile fine-tune olur.
...
TARGET_POINT_MAX_EPOCHS = 20 # fine-tune artik gercekten ogreniyor -> biraz daha alan
