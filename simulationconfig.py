...
# --- .env: makineye ozel yollar (her PC kendi .env'ini doldurur) ---
_env_file = os.path.join(CAR_PATH, '.env')
...
MODELS_PATH = os.path.join(CAR_PATH, 'data', 'models')
...
#CAMERA
CAMERA_TYPE = "MOCK"   # (PICAM|WEBCAM|CVCAM|CSIC|V4L|D435|OAKD|MOCK|IMAGE_LIST)
IMAGE_W = 320
IMAGE_H = 240
...
DEFAULT_MODEL_TYPE = 'target_point'
...
# Target-point Phase 1
TARGET_POINT_ENABLED = True
TARGET_POINT_LOOKAHEAD_METERS = 1.0
TARGET_POINT_MODEL_ARCH = 'efficient'   # GAP-based, compact enough for Jetson Nano class deployments
TARGET_POINT_IMAGE_W = 128
TARGET_POINT_IMAGE_H = 128
TARGET_POINT_CROP_TOP = 10              # 160x120 external feeds: keep horizon while preserving lane geometry
TARGET_POINT_CROP_BOTTOM = 0
TARGET_POINT_CROP_LEFT = 0
TARGET_POINT_CROP_RIGHT = 0
TARGET_POINT_BATCH_SIZE = 128
TARGET_POINT_MAX_EPOCHS = 30
TARGET_POINT_EARLY_STOP_PATIENCE = 8
TARGET_POINT_MIN_DELTA = 0.0001
TARGET_POINT_SEED = 42
TARGET_POINT_LEARNING_RATE = 0.0005
TARGET_POINT_LOSS_X_WEIGHT = 2.5
TARGET_POINT_LOSS_Y_WEIGHT = 1.0
TARGET_POINT_TARGET_MIN_STD = 0.05
TARGET_POINT_CURVATURE_SAMPLE_WEIGHT = 1.5
TARGET_POINT_TURN_SAMPLE_WEIGHT_BONUS = 0.75
TARGET_POINT_TURN_THRESHOLD_DEG = 10.0
TARGET_POINT_MAX_SAMPLE_WEIGHT = 5.0
TARGET_POINT_RECOVERY_SAMPLE_WEIGHT = 2.0
TARGET_POINT_ROLLOUT_SAMPLE_WEIGHT = 1.5
TARGET_POINT_FIRST_DEVIATION_SAMPLE_WEIGHT = 0.75
TARGET_POINT_FAILURE_MARGIN_SAMPLE_WEIGHT = 1.5
TARGET_POINT_CTE_SAMPLE_WEIGHT = 1.0
TARGET_POINT_CENTERLINE_SAMPLE_WEIGHT = 0.75
TARGET_POINT_LATERAL_SAMPLE_WEIGHT = 1.0
TARGET_POINT_TRAIN_RECOVERY_RATIO = 0.45
TARGET_POINT_HARD_EXTRA_FRACTION = 0.40
TARGET_POINT_HARD_CTE_THRESHOLD = 0.60
TARGET_POINT_HARD_CENTERLINE_THRESHOLD = 0.40
TARGET_POINT_HARD_CURVATURE_THRESHOLD = 0.40
TARGET_POINT_HARD_TARGET_X_THRESHOLD = 0.15
TARGET_POINT_DROPOUT = 0.05
TARGET_POINT_L2_REG = 1.0e-5
TARGET_POINT_COLLAPSE_MONITOR_SAMPLES = 256
TARGET_POINT_STEER_GAIN = 1.35
TARGET_POINT_STEER_SIGN = 1.0
# Right-drift compensation (effective_x = predicted_x - bias)
TARGET_POINT_TARGET_X_BIAS_M = 0.08
# Ignore tiny residual lateral commands around center
TARGET_POINT_TARGET_X_DEADBAND_M = 0.02
TARGET_POINT_THROTTLE = 0.2
TARGET_POINT_MIN_FORWARD = 0.05
TARGET_POINT_CURVATURE_GAIN = 0.45
TARGET_POINT_ANGLE_BOOST = 0.90
TARGET_POINT_LATERAL_BOOST = 0.60
TARGET_POINT_RECOVERY_ANGLE_DEG = 6.0
TARGET_POINT_RECOVERY_TARGET_X_M = 0.12
TARGET_POINT_TURN_THROTTLE_REDUCTION = 0.15
TARGET_POINT_MIN_THROTTLE_SCALE = 0.85
TARGET_POINT_DYNAMIC_THROTTLE = True
TARGET_POINT_BASE_THROTTLE = 0.20       # safer real-track default for first autonomous runs
TARGET_POINT_MIN_THROTTLE = 0.07        # keep enough momentum while reducing corner overshoot
TARGET_POINT_CURVATURE_THROTTLE_ANGLE_DEG = 4.0  # early trigger → preemptive braking
TARGET_POINT_STEER_RATE_LIMIT = 0.15    # max steering change per frame — smooth turns
TARGET_POINT_ANTICIPATION_FRAMES = 10   # sliding window size (~0.5s at 20fps)
TARGET_POINT_ANTICIPATION_GAIN = 3.5    # how much rising trend boosts effective curvature
TARGET_POINT_LABEL_MODE = 'adaptive_v1'
TARGET_POINT_LABEL_SOURCE = 'clean'
TARGET_POINT_MANIFEST_ROOT = os.path.join(CAR_PATH, 'data', 'sim_multitrack', 'index')
TARGET_POINT_EXPERIMENT_PREFIX = 'phase4'
TARGET_POINT_ENABLE_AUGMENTATION = True
TARGET_POINT_AUG_CLIP_FRAMES = 5
TARGET_POINT_AUG_BRIGHTNESS_LIMIT = 0.20
TARGET_POINT_AUG_CONTRAST_LIMIT = 0.20
TARGET_POINT_AUG_BLUR_RADIUS_MAX = 1.0
TARGET_POINT_AUG_RGB_SHIFT_MAX = 12
TARGET_POINT_AUG_SHIFT_PX_MAX = 6.0
TARGET_POINT_AUG_ROTATION_DEG_MAX = 2.5
TARGET_POINT_AUG_PERSPECTIVE_PX_MAX = 5.0
...
TARGET_POINT_EVAL_EPISODES_PER_TRACK = 1
TARGET_POINT_EVAL_MAX_STEPS = 2200
TARGET_POINT_EVAL_OFFTRACK_CTE_M = 1.0
TARGET_POINT_EVAL_OFFTRACK_CENTERLINE_M = 1.1
TARGET_POINT_EVAL_OFFTRACK_HOLD_STEPS = 3
TARGET_POINT_EVAL_RECOVERY_TRIGGER_CTE_M = 0.60
TARGET_POINT_EVAL_RECOVERY_RECENTER_CTE_M = 0.30
TARGET_POINT_EVAL_RECOVERY_WINDOW_SEC = 2.0
TARGET_POINT_EVAL_RECENTER_HOLD_STEPS = 3
TARGET_POINT_EVAL_CORNER_CURVATURE_THRESHOLD = 0.40
TARGET_POINT_EVAL_OSCILLATION_STEER_THRESHOLD = 0.15
TARGET_POINT_EVAL_MAX_PROGRESS_DELTA_M = 3.0
TARGET_POINT_BOOTSTRAP_FIRST_DEVIATION_CTE_M = 0.25
TARGET_POINT_BOOTSTRAP_FIRST_DEVIATION_CENTERLINE_M = 0.25
TARGET_POINT_BOOTSTRAP_RECENTER_CTE_M = 0.25
TARGET_POINT_BOOTSTRAP_RECENTER_CENTERLINE_M = 0.25
TARGET_POINT_BOOTSTRAP_RECENTER_HOLD_STEPS = 3
TARGET_POINT_BOOTSTRAP_FAILURE_MARGIN_STEPS = 20
TARGET_POINT_BOOTSTRAP_MIN_USABLE_RECOVERY_SAMPLES = 120
TARGET_POINT_BOOTSTRAP_ROLLOUT_MAX_SHARE = 0.35
TARGET_POINT_BOOTSTRAP_GENERATED_ROADS_MAX_SHARE = 0.10

# External real-world dataset integration (Faz 3)
# Boş bırakılırsa sadece sim verisiyle eğitilir. Gerçek veri varsa tam yolu gir.
# Örnek: TARGET_POINT_EXTERNAL_ROOT = "C:/your/path/data/datasets/mega_dataset/tubs"
TARGET_POINT_EXTERNAL_ROOT = ""
TARGET_POINT_EXTERNAL_DATA_RATIO = 0.30     # 30% external data in mixed training
TARGET_POINT_EXTERNAL_SAMPLE_WEIGHT = 0.5   # lower weight for pseudo labels
TARGET_POINT_REAL_TRACK_SAMPLE_WEIGHT = 1.25

# External dataset quality gates (applied before sampling/mixing)
TARGET_POINT_EXTERNAL_EXCLUDED_TUBS = (
    "autorope__hive_ps3_cam",
    "autorope__driveway_120fov_leftlane",
)
TARGET_POINT_EXTERNAL_MIN_USABLE_RATIO = 0.10
TARGET_POINT_EXTERNAL_MAX_MISSING_IMAGE_RATIO = 0.05

# Steering-balance train-time horizontal flip (no offline duplication)
TARGET_POINT_STEERING_BALANCE_FLIP_ENABLED = True
TARGET_POINT_STEERING_BALANCE_THRESHOLD = 0.05
TARGET_POINT_STEERING_BALANCE_POS_FLIP_PROB = 0.65
TARGET_POINT_STEERING_BALANCE_NEG_FLIP_PROB = 0.25

ARTIFACTS_PATH = os.path.join(CAR_PATH, 'data', 'artifacts')
TARGET_POINT_OUTPUT_PATH = os.path.join(ARTIFACTS_PATH, 'target_point')
TARGET_POINT_EXPERIMENTS_PATH = os.path.join(TARGET_POINT_OUTPUT_PATH, 'experiments')
TARGET_POINT_REPORTS_PATH = os.path.join(TARGET_POINT_OUTPUT_PATH, 'reports')
TARGET_POINT_DATA_INDEX_PATH = os.path.join(DATA_PATH, 'index')
TARGET_POINT_TRAIN_TRACKS = (
...
TARGET_POINT_VAL_TRACKS = (
    "donkey-roboracingleague-track-v0",
)
TARGET_POINT_TEST_TRACKS = ()
TARGET_POINT_TRACK_SPLITS = {
    "train": TARGET_POINT_TRAIN_TRACKS,
    "val": TARGET_POINT_VAL_TRACKS,
    "test": TARGET_POINT_TEST_TRACKS,
}
...
#     your `mycar` folder, next to `simulationconfig.py`, then you would add 
#     the following to your simulationconfig.py file (keeping with the crop example);
...
#     the you would add the following property to your `simulationconfig.py` file:
...
#   you need to your simulationconfig.py, then read them in the constructor.
...
TRANSFORMATIONS = []           # keep simulator frames at their native resolution unless a model explicitly changes them
...
WEB_INIT_MODE = "user"              # avoid assuming an autopilot model is already available
...
DONKEY_GYM = True
DONKEY_SIM_PATH = os.environ.get("DONKEY_SIM_PATH", "remote")  # .env'den gelir; bkz .env.example
...
GYM_CONF["start_delay"] = DONKEY_SIM_START_DELAY
...
SMOKE_TEST_STEPS = 5
SMOKE_TEST_STEERING = 0.0
SMOKE_TEST_THROTTLE = 0.2
...
# ------------------- ŞERİT TAKİP ALGORİTMASI AYARLARI -------------------
# Bu ayarlar cv_control şablonu için kritiktir.

# Algoritmanın şeridi arayacağı "tespit çubuğu"nun konumunu ayarlar.
# Görüntünün üstünden 60 piksel aşağıda, 40 piksel yüksekliğinde bir alana bakacak.
SCAN_Y = 60
SCAN_HEIGHT = 40

# Simülatördeki şeritler sarı renktedir. Bu değerler, "sarı" rengin HSV renk uzayındaki
# aralığını belirtir. Algoritma bu renk aralığındaki pikselleri şerit olarak kabul eder.
COLOR_THRESHOLD_LOW = (20, 100, 100)   # Koyu Sarı için HSV
COLOR_THRESHOLD_HIGH = (40, 255, 255)  # Açık Sarı için HSV

# PID Kontrolcü Ayarları: Aracın şeride ne kadar sert tepki vereceğini belirler.
# Başlangıç için bu değerler genellikle yeterlidir.
PID_P = 0.008
PID_I = 0.000
PID_D = 0.0001

# Otonom modda kullanılacak sabit gaz değeri.
PID_THROTTLE = 0.3
...
# PI connection
PI_USERNAME = os.environ.get("PI_USERNAME", "pi")
PI_HOSTNAME = os.environ.get("PI_HOSTNAME", "donkeypi.local")
