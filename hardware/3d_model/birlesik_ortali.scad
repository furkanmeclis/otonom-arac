// ============================================================
// BIRLESİK_ORTALI.SCAD — Montaj Önizlemesi (İç tabla ortalı)
// SADECE görsel kontrol. Baskı için kapak_ortali.scad kullanın.
// F6 = tam render
// ============================================================
...
M3D=3.6; MH_X1=33.5; MH_X2=176.5; MH_Y1=69; MH_Y2=112;
SC_W=80; SC_D=60;
