// ============================================================
// KAPAK_ORTALI.SCAD — RC Otonom Araç Üst Kapak  v2.0
// Montaj tipi: İç tabla (49×150mm) şasi ortasında
//
// Vida pozisyonları DWG "Araç Üst Tabla" çizimine göre:
//   plaka X: (210-150)/2=30 → 180mm  (ortada)
//   plaka Y: (180-49)/2=65.5 → 114.5mm (ortada)
...
// === M3 ŞASİ MONTAJ DELİKLERİ — iç tabla ortalı ===
// Plaka 49×150mm, şasi ortasında
M3D  = 3.6;
MH_X1 = 33.5;   // (210-150)/2 + 3.5
MH_X2 = 176.5;  // (210-150)/2 + 150 - 3.5
...
difference() {
    ...
    // ── M3 şasi montaj delikleri (iç tabla ortalı konuma göre) ──
